...
public interface TileIO 
{
	...
	Set getTiles(int xLeft, int xRight, int yUpper, int yLower);
	...
	Set getCache(int xLeft, int xRight, int yUpper, int yLower);
	...
	void preloadCache(int movement, int xLeft, int xRight, int yUpper, int yLower);
	...
	void loadTiles(HashMap columns);
