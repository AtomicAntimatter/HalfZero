...
public class Map {
	...
	public void moveMap(float moveX, float moveY) {
		...
		if (center.i() <= 0) {
			float preX = moveX < 0 ? moveX
				: (center.neighbor(Tile.Direction.SE) != null) ? moveX : 0;
			float preY = moveY > 0 ? moveY
				: (center.neighbor(Tile.Direction.SE) != null) ? moveY : 0;
			moveX = ((preY < 0) && (center.neighbor(Tile.Direction.SE) != null)) ? moveY : preX;
			moveY = ((preX > 0) && (center.neighbor(Tile.Direction.SE) != null)) ? moveX : preY;
		} else if (center.i() >= map.width() - 1) {
			float preX = moveX > 0 ? moveX
				: (center.neighbor(Tile.Direction.NW) != null) ? moveX : 0;
			float preY = moveY < 0 ? moveY
				: (center.neighbor(Tile.Direction.NW) != null) ? moveY : 0;
			moveX = ((preY > 0) && (center.neighbor(Tile.Direction.NW) != null)) ? moveY : preX;
			moveY = ((preX < 0) && (center.neighbor(Tile.Direction.NW) != null)) ? moveX : preY;
		}
		if (center.j() <= 0) {
			float preX = moveX < 0 ? moveX
				: (center.neighbor(Tile.Direction.NE) != null) ? moveX : 0;
			float preY = moveY < 0 ? moveY
				: (center.neighbor(Tile.Direction.NE) != null) ? moveY : 0;
			moveX = ((preY > 0) && (center.neighbor(Tile.Direction.NE) != null)) ? moveY : preX;
			moveY = ((preX > 0) && (center.neighbor(Tile.Direction.NE) != null)) ? moveX : preY;
		} else if (center.j() >= map.height() - 1) {
			float preX = moveX > 0 ? moveX
				: (center.neighbor(Tile.Direction.SW) != null) ? moveX : 0;
			float preY = moveY > 0 ? moveY
				: (center.neighbor(Tile.Direction.SW) != null) ? moveY : 0;
			moveX = ((preY < 0) && (center.neighbor(Tile.Direction.SW) != null)) ? moveY : preX;
			moveY = ((preX < 0) && (center.neighbor(Tile.Direction.SE) != null)) ? moveX : preY;
		}
		offsetX -= moveX;
		offsetY -= moveY;
	...
	private void findBounds() {
		boundX[1] = width + center.i();
		boundY[1] = height + center.j();
		boundX[0] = center.i() - width;
		boundY[0] = center.j() - height;
	}
